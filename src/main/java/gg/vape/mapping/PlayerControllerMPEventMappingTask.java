...
extends JavassistMappingTask {
    public static final boolean U = ForgeVersion.MC_1_16_5.d() && (Vapor.INSTANCE.isForgeAbsent() || Vapor.INSTANCE.isVanillaMinecraftPresent());
    ...
    public void transform() {
        Object object;
        MappingMethod mappingMethod = Vapor.INSTANCE.getMappings().hj.c;
        if (ForgeVersion.MC_1_12_2.v()) {
            ...
            this.O(mappingMethod, PlayerUseItemCallback.class, (String)object, MappedClasses.zr.getName() + "." + Vapor.INSTANCE.getMappings().enumActionResult.passField.getResolvedName());
        }
        this.c(Vapor.INSTANCE.getMappings().hj.L, EventBedBreakerUpdate.class, "");
        if (!U) {
            object = Vapor.INSTANCE.getMappings().hj.i;
            this.c((MappingMethod)object, EventPreAttack.class, "$2");
            this.k((MappingMethod)object, EventPostAttack.class, "$2");
        }
        this.O(Vapor.INSTANCE.getMappings().hj.I, EventWindowClick.class, "$0", "null");
    }
