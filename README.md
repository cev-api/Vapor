...
This release converts [OpenVapeCN 4.21](https://github.com/OpenVapeCN/VapeV4.21) into a standalone Fabric client mod for Minecraft 26.2.

The project builds a standard Fabric mod JAR. It does not build or use a native DLL, injector executable, embedded Java payload, or native CMake project.

## Project Scope 

This project was created as a proof of concept to determine whether the recovered [OpenVapeCN 4.21](https://github.com/OpenVapeCN/VapeV4.21) Java client could be converted into a standalone Fabric mod for Minecraft 26.2 without relying on native injection.
...
Individual hacks and modules have received basic functional testing, but the recovered feature set has not been exhaustively tested, validated for complete behavioral accuracy, or compared feature-for-feature against upstream [OpenVapeCN 4.21](https://github.com/OpenVapeCN/VapeV4.21). Reproducing every upstream behavior was not the purpose of this project.
...
```text
build/libs/Vapor-FabricMC26.2_v4.21.jar
build/libs/Vapor-FabricMC26.2_v4.21-sources.jar
```
...
This is a Fabric conversion of a recovered client implementation by [OpenVapeVN](https://github.com/OpenVapeCN/), and is not based on the original official Vape source.