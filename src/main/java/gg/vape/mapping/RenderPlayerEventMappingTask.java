...
extends JavassistMappingTask {
    ...
    public void transform() {
        MappingMethod mappingMethod = Vapor.INSTANCE.getMappings().renderPlayer.renderMethod;
        if (!ForgeVersion.MC_1_21_0.d()) {
            if (ForgeVersion.MC_1_16_5.d()) {
                ...
                if (ForgeVersion.MC_1_7_10.L()) {
                    MappingMethod mappingMethod2 = Vapor.INSTANCE.getMappings().renderPlayer.shouldRenderPassMethod;
                    ...
                    MappingMethod mappingMethod3 = Vapor.INSTANCE.getMappings().renderPlayer.renderEquippedItemsMethod;
