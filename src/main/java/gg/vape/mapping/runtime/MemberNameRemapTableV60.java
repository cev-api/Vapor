...
public class MemberNameRemapTableV60
extends MemberNameRemapTable {
    ...
    protected void i3() {
        ...
        this.f(MappedClasses.zs, "renderLevel", "renderLevel", Void.TYPE, MappedClasses.Ds, MappedClasses.uy, Boolean.TYPE, MappedClasses.lt, MappedClasses.qr, MappedClasses.qr, MappedClasses.qr, MappedClasses.qk, MappedClasses.FC, Boolean.TYPE);
    ...
    protected void v$src$V$1ko6s64() {
    ...
    protected void C$src$V$1jw59wp() {
