...
extends JavassistMappingTask {
    ...
    public void transform() {
        if (ForgeVersion.c() == ForgeVersion.MC_1_8_9.i()) {
            this.O(Vapor.INSTANCE.getMappings().U.V, EventPreRenderLivingSpecials.class, "$1", "");
            return;
        }
        if (ForgeVersion.c() != ForgeVersion.MC_1_21_11.i()) {
            return;
        }
        this.O(Vapor.INSTANCE.getMappings().U.d, EventPreRenderLivingSpecials.class, "$2", "0");
    }
}
