...
extends TutorialPage {
    public TextGuiTutorialPage() {
        ...
        this.addAction(new SingleComponentHighlightTutorialAction(ClientSettings.getFrame(QuickActionsFrame.class), "Overlays menu", "Here you can enable overlays in Vapor. Overlays are frames that will render on-top of your screen while in game.", false).setTooltipPlacement(TutorialTooltipPlacement.RIGHT));
