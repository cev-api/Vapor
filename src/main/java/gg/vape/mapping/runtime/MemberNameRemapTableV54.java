...
public class MemberNameRemapTableV54
extends MemberNameRemapTable {
    ...
    protected void vT() {
        ...
        this.f(MappedClasses.zs, "renderLevel", "renderLevel", Void.TYPE, MappedClasses.Ds, MappedClasses.uy, Boolean.TYPE, MappedClasses.lt, MappedClasses.FW, MappedClasses.qr, MappedClasses.qr);
