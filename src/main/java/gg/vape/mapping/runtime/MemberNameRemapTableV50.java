...
public class MemberNameRemapTableV50
extends MemberNameRemapTable {
    ...
    protected void OZ() {
        ...
        this.f(MappedClasses.zs, "updateCameraAndRender", "renderLevel", Float.TYPE, Long.TYPE, Boolean.TYPE, MappedClasses.lt, MappedClasses.FW, MappedClasses.zH, MappedClasses.qr, MappedClasses.qr);
    ...
    protected void q() {
        this.t(MappedClasses.Fj, "getShape", "getShape");
    }
    ...
    protected void OD() {
        ...
        this.t(MappedClasses.zc, "getPosY", "getY");
        this.t(MappedClasses.zc, "setPositionAndRotation", "moveTo");
        this.t(MappedClasses.zc, "getEyePosition", "getEyePosition");
    }
    ...
    protected void Af() {
        this.t(MappedClasses.F6, "listPlayerScores", "listPlayerScores");
    }
    ...
    protected void Av() {
        ...
        this.t(MappedClasses.uk, "clip", "clip");
        this.t(MappedClasses.uk, "inflate", "inflate");
        this.t(MappedClasses.uk, "contains", "contains");
    }
    ...
    protected void v$src$V$rukb3x() {
        ...
        this.t(MappedClasses.uQ, "width", "width");
    }
    ...
    protected void AY() {
        ...
        this.t(MappedClasses.ls, "fogDensity", "setShaderFogStart");
        ...
        this.t(MappedClasses.ls, "m_157179_", "_setShaderTexture");
        this.t(MappedClasses.ls, "m_157182_", "applyModelViewMatrix");
    }
