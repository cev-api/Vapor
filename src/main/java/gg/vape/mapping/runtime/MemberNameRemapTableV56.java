...
public class MemberNameRemapTableV56
extends MemberNameRemapTable {
    ...
    protected void C$src$V$183sg7k() {
    ...
    protected void v$src$V$18vtygz() {
    ...
    protected void jn() {
        ...
        this.f(MappedClasses.zs, "renderLevel", "renderLevel", Void.TYPE, MappedClasses.Ds, MappedClasses.uy, Boolean.TYPE, MappedClasses.lt, MappedClasses.qr, MappedClasses.qr, MappedClasses.qk, MappedClasses.FC, Boolean.TYPE);
