...
public class ModuleInteractiveComponent
extends InteractiveComponent {
    ...
    public ModuleInteractiveComponent(String label, @Nullable String leadingIconResource, Supplier<Boolean> selectedSupplier, @Nullable Supplier<Integer> countSupplier, @Nullable String trailingIconResource) {
        ...
        this.getClass();
        this.hoverBackgroundAnimation = new ColorAnimation(0.15, ModuleInteractiveComponent.J.t, ModuleInteractiveComponent.J.E);
        this.getClass();
        ...
        this.countBadge = new ShapeIconComponent(IconShape.CIRCLE, "0", BADGE_SIZE, 0.0, 0.0, CORNER_RADIUS, ModuleInteractiveComponent.J.d, Color.WHITE, BADGE_TEXT_SCALE);
    ...
    public ModuleInteractiveComponent(String label, @Nullable String leadingIconResource, Supplier<Boolean> selectedSupplier) {
