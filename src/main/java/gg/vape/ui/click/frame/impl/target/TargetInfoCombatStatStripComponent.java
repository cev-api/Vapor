...
extends TargetInfoStatStripComponent {
    ...
    public void H() {
        String string;
        super.H();
        Color color = this.comparisonValue > 0 ? TargetInfoCombatStatStripComponent.J.B : (this.comparisonValue < 0 ? TargetInfoCombatStatStripComponent.J.d : TargetInfoCombatStatStripComponent.J.A);
        ...
        ImageRenderer.drawImage(color2, (float)this.G$src$D$1b2f02a() + 4.0f, (float)this.n() + 2.0f, "pot_normal", 6.0f, 6.0f, false);
